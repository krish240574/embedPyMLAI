...
all_data:all_data,'([]daysinmonth:{dom:(31 28 31 30 31 30 31 31 30 31 30 31);f:dom -1+`mm$tenp`date;:f:@[f;where {mod[;2] sum 0=x mod\: 4 100 400} each `year$tenp`date;:;29]})
