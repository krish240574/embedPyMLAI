/ Updated to 0.2-beta - a bunch of methods changed, a few deprecated. 
...
/ deprecated - ver 1 train:.p.obj2dict .p.get[`train]; / convert to dict, so one can reach the values[] call
p)tvals = train.values
train:.p.get`tvals
train:fills train`;
/ deprecated train:.p.py2q train.values[] / this gets the shape intact 806928x111
kcols:`$kcols`
...
/ deprecated - corrmat:.p.obj2dict .p.get[`corrmat]
corrmat:.p.get`corrmat
/ deprecated - corrmat:.p.py2q corrmat.values[]
